...
public:
    ...
    std::list<Dragon*> GetDragons () const;

    void Accommodate (Dragon *drag);
...
private:
    std::list<Dragon*> sisi_;
DragonCave(const DragonCave& obj)=delete;
DragonCave& operator=(const DragonCave& obj)= delete ;
