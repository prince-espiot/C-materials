...
std::string ToString(it string, it itera){
...
std::string ToString (const container& con){

    return ToString (con.begin(), con.end());
}


template <> 
std::string ToString(const std::string& sin){
